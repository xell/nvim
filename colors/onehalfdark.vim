...
let s:white       = { "gui": ["#dcdfe4", "#CED2D9", "#C0C5CE", "#d7d7d8"][2], "cterm": "188" }

let s:fg          = s:white
let s:bg          = s:black

let s:comment_fg  = { "gui": "#9BA7BD", "cterm": "241" }
...
let s:selection   = { "gui": "#5A6275", "cterm": "239" }
...
call s:h("TabLineSel", s:blue, s:bg, "")
