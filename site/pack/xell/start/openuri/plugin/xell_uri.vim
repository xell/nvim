...
function! OpenInBrowser(strict, ...)
	...
	elseif a:0 == 1 && a:1 != ''
        ...
        " 202201 Current file name in % register is invalid
        " https://github.com/vscode-neovim/vscode-neovim/issues/798
        if exists('g:vscode')
            let cur_file_path = substitute(cur_file_path, '^.\{-}__vscode_neovim__-file:\/\/', '', '')
        endif
	endif
